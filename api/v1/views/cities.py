...
def city_by_state(state_id):
    """
    it retrieves all City objects from a specific state
    and return: json  all cities in a state or 404 on error
    """
    city_list = []
...
def city_create(state_id):
    ...
    returns: newly created city obj
    """
...
def city_by_id(city_id):
    """
    it gets a specific City object by ID
...
def city_put(city_id):
    """
    update specific City object by ID
    param city_id: city object ID
